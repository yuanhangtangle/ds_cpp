...
int main()
{
    ...
    //X89, 4-3-a
    cout << test_permutation(A, n) << endl;
    cout << test_permutation(B, n) << endl;
    cout << endl;

    cout << orderBetween('+','-') << endl;
    cout << calc(9, 8, '+') << endl;
    cout << frac(5) << endl;
    cout << "P94, 4.3.3" << endl;
    cout << evaluate(expr, rpn) << endl;
    cout << RPN << endl;
    cin >> n;
    return 0;
}
